...
public class GesturesTest1 extends BaseTest {
        ...
        public void longClickAtCenterOfTheElement() {
                ...
                driver1.findElement(AppiumBy.accessibilityId("Drag and Drop")).click();
                WebElement element = driver1.findElement(AppiumBy.id("io.appium.android.apis:id/drag_dot_1"));
                // Java
                ((JavascriptExecutor) driver1).executeScript("mobile: longClickGesture", ImmutableMap.of(
        ...
        public void clickGestureTest() {
                ...
                WebElement element = driver1.findElement(AppiumBy.id("io.appium.android.apis:id/drag_dot_1"));
                // Java
                ((JavascriptExecutor) driver1).executeScript("mobile: clickGesture", ImmutableMap.of(
                                "elementId", ((RemoteWebElement) element).getId())); // key value pair
        ...
        public void pinchOpenGestureTest() throws InterruptedException {
                ...
                driver1.findElement(By.xpath("//android.widget.TextView[@text='Graphics']")).click();
                driver1.findElement(AppiumBy.androidUIAutomator(
                ...
                WebElement graphicsElement = driver1.findElement(By.id("android:id/content"));
                ...
                driver1.executeScript("mobile: pinchOpenGesture", params);
        ...
        public void pinchCloseGestureTest() throws InterruptedException {
                ...
                driver1.executeScript("mobile: pinchCloseGesture", params);
        ...
        public void swipeLeftGestureTest() throws InterruptedException {
                ...
                Thread.sleep(2000);
                driver1.findElement(AppiumBy.accessibilityId("1. Photos")).click();
                Thread.sleep(2000);
                WebElement firstPhoto = driver1
                                .findElement(AppiumBy.xpath(
                                                "(//android.widget.ImageView[@class='android.widget.ImageView'])[1]"));
                // Java
        ...
        public void swipeRightGestureTest() throws InterruptedException {
                ...
                // swipe right
                WebElement secondPhoto = driver1
                                .findElement(AppiumBy.xpath(
                                                "(//android.widget.ImageView[@class='android.widget.ImageView'])[2]"));
                // Java
                ((JavascriptExecutor) driver1).executeScript("mobile: swipeGesture", ImmutableMap.of(
        ...
        public void swipeUpGestureTest() throws InterruptedException {
                driver1.findElement(AppiumBy.accessibilityId("Views")).click();
                Thread.sleep(3000);
                WebElement element = driver1.findElement(AppiumBy.id("android:id/list"));
                // Java
                ((JavascriptExecutor) driver1).executeScript("mobile: swipeGesture", ImmutableMap.of(
        ...
        public void scrollGestureByBoundingAreaTest() {
                ...
                boolean canScrollMore = (Boolean) ((JavascriptExecutor) driver1).executeScript("mobile: scrollGesture",
                                ImmutableMap.of(
                                                "left", 100, "top", 100, "width", 200, "height", 200, // scroll by this
                                                                                                      // bound area
                                                                                                      // defined by
                                                                                                      // ,200,200
                                                "direction", "down",
        ...
        public void scrollGestureByElementAreaTest() {
                ...
                WebElement element = driver1.findElement(AppiumBy.accessibilityId("Animation"));
        ...
        public void scrollGestureAllTheWayDownTest() {
                ...
                while (canScrollMore) {
                        canScrollMore = (Boolean) ((JavascriptExecutor) driver1).executeScript("mobile: scrollGesture",
                                        ImmutableMap.of(
